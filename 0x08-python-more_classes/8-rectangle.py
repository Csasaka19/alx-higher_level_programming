#!/usr/bin/python3
"""
This module defines the a Rectangle class and has 12 functions
"""


class Rectangle:
    """Retangle class that has getters setters properties str and repr methods, a static method  and a class method
    """
